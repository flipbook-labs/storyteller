...
Storyteller handles story discovery, loading, and rendering for Flipbook. It wraps [ModuleLoader](https://github.com/flipbook-labs/module-loader) to reload stories without Roblox's require cache, and is consumed by Flipbook as a Wally package. It is written in Luau and built with Lute. This file is the entry point for any agent working in the repo. It routes you to the shared skills library and the repo's own setup.
